...
static memcached_return_t memcached_key_process(
	memcached_st *ptr, 
	const char *key, 
	size_t key_length, 
	void *_context ) {
		...
		FeriteVariable *key_variable = ferite_create_string_variable_from_ptr( script, "", key, key_length, FE_CHARSET_DEFAULT, FE_STATIC );
